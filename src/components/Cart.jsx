          ...
          ? shoppingCart.map((product) => (
              <div className="cart" key={product.id}>
                ...
                <span className="productTotalPrice">
                  ${product.qty * product.price.toFixed(3)}
                </span>
                <button
                  onClick={() =>
        ...
        <div className="cartSummary">
          <div className="summary">
            ...
            <div className="totalItems">
              <div className="items">Total de productos</div>
              <div className="itemsCount">{qty}</div>
            </div>
            <div className="totalPriceSection">
              <div className="justTitle">Total a pagar</div>
              <div className="itemsPrice">${totalPrice.toFixed(3)}</div>
            </div>
            <div className="stripSection"></div>
          </div>
        </div>
      ) : (
        ""
